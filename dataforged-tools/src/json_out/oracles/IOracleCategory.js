 ...
 * @public
 */
export var OracleCategoryFlatName;
(function (OracleCategoryFlatName) {
    OracleCategoryFlatName["CharacterCreation"] = "Character Creation";
    OracleCategoryFlatName["Characters"] = "Characters";
    OracleCategoryFlatName["Core"] = "Core";
    OracleCategoryFlatName["Creatures"] = "Creatures";
    OracleCategoryFlatName["Factions"] = "Factions";
    OracleCategoryFlatName["Misc"] = "Misc";
    OracleCategoryFlatName["Moves"] = "Moves";
...
(function (OracleCategoryJaggedName) {
    ...
    OracleCategoryJaggedName["LocationThemes"] = "Location Themes";
