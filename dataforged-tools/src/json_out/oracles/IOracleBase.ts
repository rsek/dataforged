import type { IHasAliases, IHasDescription, IHasDisplay, IHasId, IHasOracleContent, IHasSource, IHasSummary, IHasText, IHasTitle, IOracleDisplayBase, IOracleSet, IOracleTable , IOracleUsage, IRow, IRowNullStub } from "@json_out/index.js";
