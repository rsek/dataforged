import type { IAlterMomentum , IAlterMove , IAssetAlterProperties, IHasId, IHasLabel, IHasName, IHasText, IInputClock, IInputNumber, IInputText, IMove } from "@json_out/index.js";
