import type { IDisplayWithTitle , IHasDescription , IHasDisplay , IHasId , IHasName, IHasOptional, IHasSource , IHasTitle, IMove } from "@json_out/index.js";
 ...
 * @public
 */
export interface IMoveCategory extends IHasId, IHasName, IHasSource, IHasDescription, IHasDisplay, IHasOptional,IHasTitle {
  /**
