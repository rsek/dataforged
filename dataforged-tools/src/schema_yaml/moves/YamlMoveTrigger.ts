import type { CustomStat, CustomStatOption, MeterAlias, MoveTrigger, MoveTriggerOptionAction, MoveTriggerOptionProgress, PlayerConditionMeter, Replacement, Stat } from "@schema_json";
