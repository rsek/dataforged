import type { AttributeChoices, HasRequirements , HasRollTemplate, HasSuggestions , Requirements , Suggestions } from "@schema_json";

/**
 * Describes the recommended usage of this item.
 * @public
 */
export interface OracleUsage extends Partial<HasRequirements & HasSuggestions & HasRollTemplate> {
  /**
