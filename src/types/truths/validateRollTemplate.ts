...
import type { RollTemplateString } from "../oracles/interfaces/IRollTemplate.js";
 ...
 * @param {T} parent - The parent object that the template is being validated against.
 * @param templateObj - RollTemplate<T>
 * @returns The original object as the validated type.
 */
export default function validateRollTemplate<T extends IRules>(parent: T, templateObj: RollTemplate<string & keyof T>) {
 ...
 * @param {MdString} str - The string to validate.
