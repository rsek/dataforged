...
public class TriggerRollOptionAction {
    ...
    private List<TriggerRollOptionActionChoice> choices;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty("text")
    private MarkdownString text;

    public TriggerRollOptionAction() {
    }
     ...
     */
    public List<TriggerRollOptionActionChoice> getChoices() {
        return choices;
    }
     ...
     */
    public void setChoices(List<TriggerRollOptionActionChoice> choices) {
