...
@JsonSerialize
public class AssetOptionFieldSelectAssetExtension extends AssetOptionField {
    ...
    public AssetOptionFieldSelectAssetExtension() {
    }

    /**
     * Getter for choices.<p>
     */
    public Map<String, AssetOptionFieldSelectAssetExtensionChoice> getChoices() {
        return choices;
    }
     ...
     */
    public void setChoices(Map<String, AssetOptionFieldSelectAssetExtensionChoice> choices) {
