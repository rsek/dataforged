...
@JsonSerialize
public class TriggerRollOptionProgress {
    @JsonProperty("method")
    ...
    private List<TriggerRollOptionProgressChoice> choices;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty("text")
    private MarkdownString text;

    public TriggerRollOptionProgress() {
    }
     ...
     */
    public List<TriggerRollOptionProgressChoice> getChoices() {
        return choices;
    }
     ...
     */
    public void setChoices(List<TriggerRollOptionProgressChoice> choices) {
