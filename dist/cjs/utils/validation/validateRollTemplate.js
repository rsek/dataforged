...
exports.validateRollTemplateString = exports.validateRollTemplate = void 0;
...
const rollTplPattern = (0, typed_regex_1.TypedRegEx)("\$\{\{(?<id>.*?)\}\}", "g");
/**
 ...
 */
function validateRollTemplate(parent, templateObj) {
    // FIXME: smarted subtable template handling.
    lodash_es_1.default.forEach(templateObj, (rollTplData, key) => {
        if (!parent[key]) {
            // console.info(parent);
            throw (0, badJsonError_js_1.badJsonError)(validateRollTemplate, templateObj, `RollTemplate key '${key}' doesn't exist on its parent object. This is necessary so that a placeholder string is provided.`);
        }
        if (rollTplData) {
            // console.log("validating template data", rollTplData);
            lodash_es_1.default.forEach(rollTplData, (v, k) => {
...
exports.validateRollTemplate = validateRollTemplate;
/**
 ...
 */
function validateRollTemplateString(str) {
    if (typeof str !== "string") {
        throw (0, badJsonError_js_1.badJsonError)(validateRollTemplateString, str, "Expected a string");
    }
    const captures = lodash_es_1.default.compact(rollTplPattern.captureAll(str).map(capture => capture === null || capture === void 0 ? void 0 : capture.id));
    captures.forEach(capture => {
        if (!(0, typescript_is_1.is)(capture, object => { function _1(object) {
            var _a;
            ...
            throw (0, badJsonError_js_1.badJsonError)(validateRollTemplateString, capture, "Doesn't appear to be a valid OracleTableId");
        }
    });
    return str;
}
exports.validateRollTemplateString = validateRollTemplateString;
