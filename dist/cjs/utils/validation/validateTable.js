 ...
 */
function validateTable(table, requireUniqueResults = true, requireAllD100 = true) {
    if (!Array.isArray(table)) {
        throw (0, badJsonError_js_1.badJsonError)(validateTable, table, "Table is not an array.");
    }
    if (table.length < 2) {
        throw (0, badJsonError_js_1.badJsonError)(validateTable, table, "Table should have at least two rows.");
    }
    let totalRange = 0;
...
//# sourceMappingURL=validateTable.js.map