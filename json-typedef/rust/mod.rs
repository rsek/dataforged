...
#[derive(Serialize, Deserialize)]
pub struct ProgressTrackTypeInfoControl {}
...
pub struct ProgressTrackTypeInfo {
    ...
    #[serde(rename = "controls")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub controls: Option<Box<HashMap<String, ProgressTrackTypeInfoControl>>>,
}
...
pub struct Source {
    ...
    /// An absolute URL pointing to the location where this element's license
    /// can be found.
    /// 
